...
# Analysis with or without final tertiary-analysis. Options: full, quant.
TERTIARY_ANALYSIS="full";

# Max number of categories showed in R plots for tertiary-analysis.
CATEGORY_NUMBER="5";
