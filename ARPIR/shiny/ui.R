               ...
               tabPanel("References",
                        fluidRow(
                          ...
                          tags$ul(style="font-size: 20px",
                                  ...
                                  tags$li("* A. Dobin, C.A. Davis, F. Schlesinger, J. Drenkow, C. Zaleski, S. Jha, P. Batut, M. Chaisson, T.R. Gingeras, \"STAR: ultrafast universal RNA-seq aligner,\" Bioinformatics, vol. 29, no. 1, pp. 15-21, 2013."),
